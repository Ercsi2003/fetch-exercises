...
document.addEventListener("DOMContentLoaded", async () =>{
  ...
  const newRatingInput = document.getElementById("rating") as HTMLInputElement;
  const deliveryStatusInput = document.getElementById("deliveryState") as HTMLInputElement;
  const newProductIdInput = document.getElementById("productId") as HTMLInputElement;
